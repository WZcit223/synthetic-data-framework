...
PR 2; PR 6 (the pages) is written on the new frontend. PR 2 to 6 merged
(#45 to #48, #50). On 2026-09-26 the "your own data" sequence
([`../userdata/00-overview.md`](../userdata/00-overview.md)), approved the
same day, replaced PR 7 with its step U6. On 2026-09-24 the project lead asked for four
...
| 7 | [`07-real-data.md`](07-real-data.md) | Replaced by step U6 of [`../userdata/00-overview.md`](../userdata/00-overview.md). Was: only with D1 (a) or (b): `sdf prepare-retail` and every algorithm of PR 1 to 5 validated on two years of real demand | none (replaced; U1 takes 1.14.0) |
